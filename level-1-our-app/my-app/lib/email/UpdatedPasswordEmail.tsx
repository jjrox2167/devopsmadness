...
interface UpdatedPasswordEmailProps {
  username: string;
  userEmail: string;
  
}

const UpdatedPasswordEmail = (props: UpdatedPasswordEmailProps) => {
        ...
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={bodyText}>
              ...
              associated with <span style={emailText}>{userEmail}</span> has been successfully reset.
            </Text>
            ...
            <Text style={instructionText}>
              If you made this change, you can safely ignore this email. For if you&apos;d like to review additonal account details, please consider
              clicking the button below:
            </Text>

            <div style={buttonContainer}>
              <Button href="https://example.com/sign-in" style={primaryButton}>
            ...
            <div style={urlBox}>
              <Text style={urlText}>https://example.com/account/activity</Text>
            </div>
          ...
          <Section style={warningSection}>
            ...
            <table style={stepsList}>
              <tr>
                ...
                <td style={stepText}>
                  navigate to the <a href="https://example.com/reset-password" style={emailLink}>password reset page</a> to secure your account
                </td>
              </tr>
              <tr>
