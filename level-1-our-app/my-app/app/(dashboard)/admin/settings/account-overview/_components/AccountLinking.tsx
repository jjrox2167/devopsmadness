...
import { BetterAuthActionButton } from "@/components/BetterAuthActionButton"
    ...
    <div className="space-y-6">
      <div className="space-y-2">
        <div className="space-y-1">
                <h3 className="text-xl font-bold">Accounts Currently Linked</h3>
                <p className="text-muted-foreground text-sm mt-1">
                  Accounts that are currently associated to your login.
                </p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              {account == null ? (
                ...
                <Badge variant="verified" className="py-auto">
